...
import de.daikol.acclaim.activity.CompetitionEditActivity;
import de.daikol.acclaim.activity.MainActivity;
...
import de.daikol.acclaim.model.AchievementStatus;
import de.daikol.acclaim.model.ApplyStatus;
import de.daikol.acclaim.model.Competition;
import de.daikol.acclaim.model.CompetitionStatus;
...
import de.daikol.acclaim.model.Reward;
import de.daikol.acclaim.model.RewardStatus;
import de.daikol.acclaim.model.user.User;
import de.daikol.acclaim.tasks.BuyRewardTask;
import de.daikol.acclaim.tasks.ConfirmCompetitionTask;
import de.daikol.acclaim.tasks.ConfirmProgressTask;
import de.daikol.acclaim.tasks.ConvertBitmapTask;
import de.daikol.acclaim.tasks.CreateProgressStepTask;
import de.daikol.acclaim.tasks.DeclineCompetitionTask;
import de.daikol.acclaim.tasks.DeclineProgressTask;
...
public class CompetitionDetailFragment extends Fragment implements Serializable, ProgressDetailDialog.ProgressDetailDialogListener, MessageCreationSupportDialog.CreateMessageDialogListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // create challenger
        challenger = (Challenger) getActivity().getApplication();
    ...
    private void createCompetitionLayout(final LayoutInflater inflater, final ViewGroup container, final View rootView) {
        ...
        if (competition != null) {
            ...
            // get the reporter
            final User me = challenger.getUser();
                    ...
                    if (!locked) {
                        ...
                        achievementPictureView.setOnLongClickListener(new View.OnLongClickListener() {
                            ...
                            public boolean onLongClick(View v) {
                                ...
                                new CreateProgressStepTask(achievement.getId(), step, challenger).execute();
                ...
                for (final Reward reward : competition.getRewards()) {
                    ...
                    if (isBuyable) {
                        rewardPictureView.setOnLongClickListener(new View.OnLongClickListener() {
                            @Override
                            public boolean onLongClick(View v) {
                                new BuyRewardTask(reward.getId(), challenger).execute();
    ...
    public void onDialogPositiveClick(ProgressStepData data) {
        new ConfirmProgressTask(data, challenger).execute();
    }

    @Override
    public void onDialogNegativeClick(ProgressStepData data) {
        new DeclineProgressTask(data, challenger).execute();
    }
