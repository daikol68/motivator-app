...
public class DeclineCompetitionTask extends AsyncTask<Void, Void, Boolean> {

    private static final String LOG_TAG = "DeclineCompetitionTask";
     ...
     * Constructor.
     */
    public DeclineCompetitionTask(long competition, Challenger challenger) {
    ...
    protected Boolean doInBackground(Void... nothing) {
        ...
        try {
            ...
            ResponseEntity<Boolean> response = restTemplate.exchange(Constants.Activities.Competition.decline + "/" + competition, HttpMethod.POST, request, Boolean.class);
